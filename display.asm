...
MessageTable:
    ...
    .db INFINITE,       0x00,   "EvEr"
    .db GRAVITY,        0x00,   "GrAu"
    .db f_invis_set,        0x00,   "Inui"
    .db BOUND,          0x00,   "EDGE"
...
DisplayMessage:
    ldi     ZL, low(MessageTable)
    ldi     ZH, high(MessageTable)
...
DisplayMessageLoadDisplayBufferInit:
    ...
    byteTabOffsetY curr_c_patterns, r16
    clr     r0
    wordTabOffsetZ ASCIISegTable, r0
